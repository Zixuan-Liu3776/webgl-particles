...
WindGL.prototype.updateParticles = function updateParticles () {
    ...
    gl.uniform1f(program.u_vertex_str, this.vortexStr);
    gl.uniform2f(program.u_vortex_pos, this.vortexPosX, this.vortexPosY);
